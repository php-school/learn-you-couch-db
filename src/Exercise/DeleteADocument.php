 ...
 */
class DeleteADocument extends AbstractExercise implements ExerciseInterface, CliExercise, CouchDbExerciseCheck
{
    /**
     * @var null|string
     */
    ...
    {
        return 'Delete an existing document';
    }
    ...
    {
        return $couchDbClient->findDocument($this->selectedAnimal)->status === 404;
    }
}
